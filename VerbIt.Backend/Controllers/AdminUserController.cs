...
namespace VerbIt.Backend.Controllers
{
    ...
    public class AdminUserController : ControllerBase
    {
        ...
        public async Task<ActionResult<AuthenticatedUser>> Create(CreateAdminUserRequest request, CancellationToken token)
        {
            AuthenticatedUser createdUser = await _repository.CreateAdminUser(request.Username, request.Password, token);
